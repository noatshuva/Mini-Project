...
# This client sends a mail with a file which its signature is different from its type.
...
with open("Files/earth.txt", 'rb') as file:
 message.add_attachment(file.read(), maintype="application", subtype="octet-stream",filename="Files/earth.txt")
